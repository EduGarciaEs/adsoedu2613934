...
<head>
    ...
    <link rel="stylesheet" href="/01-oop/css/master.css">
    <style>
        section {
    ...
    <main>
        ...
        <section>
            ...
            <form action="" method="post">
                <label>
                    <p>Rows:</p>
                    <input type="range" name="nr" min="1" max="20" step="1" oninput="o1.value=this.value">
                    <output id="o1">1</output>
                </label>
                <label>
                    <p>Columns:</p>
                    <input type="range" name="nc" min="1" max="20" step="1" oninput="o2.value=this.value">
